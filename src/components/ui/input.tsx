    ...
    const inputElement = (
      <div className="relative w-full">
        <input
          type={type}
          className={clsx(
            "flex h-11 w-full bg-[var(--color-gray-0)] px-4 text-sm text-[var(--color-gray-950)]",
        ...
        {hasCopyButton && (
          <button
            type="button"
            onClick={handleCopy}
            className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 bg-[var(--color-gray-0)] border border-[var(--color-gray-200)] hover:bg-[var(--color-gray-50)] flex items-center justify-center transition-colors cursor-pointer"
